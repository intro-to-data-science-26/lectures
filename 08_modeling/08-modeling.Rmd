...
.pull-left-center[
<div align="center">
<img src="pics/nested-models-chen.png" width=500>
</div>
...
.pull-right[
<div align="center">
<img src="pics/multiverse-analysis-1.png" width=500>
...
```{r}
modelsummary(list(model1_out, model2_out, model3_out), output = "gt")
```
...
No new assignment this time - but don't forget about the quiz!
