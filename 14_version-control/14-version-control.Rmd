...
- According to [StackOverflow's 2022 Developer Survey](https://survey.stackoverflow.co/2022/#technology-version-control), more than 93% of respondents report to use Git - more than any other tool.
]
...
- There are many [Git GUIs](https://git-scm.com/downloads/guis/), giving you the option to use git without the shell (often with reduced functionality). A popular choice is [GitHub Desktop](https://desktop.github.com/), but we will mainly use the [Git integration into the RStudio IDE](https://docs.posit.co/ide/user/ide/guide/tools/version-control.html).
]
...
- There are [100m+ developers on Github](https://github.blog/news-insights/research/the-state-of-open-source-and-ai/), with 98m+ new repositories created in 2023 alone.
...
- I host most of the code and data for my [papers](https://simonmunzert.github.io/publications.html) on GH. My [website](https://simonmunzert.github.io/) lives there. And this [course](https://github.com/intro-to-data-science-24) does, too.
]
...
Check out [these setup instructions](https://swcarpentry.github.io/git-novice/02-setup.html) from [Software Carpentry](https://software-carpentry.org/) to learn about more configuration options.
...
- Only once you (and your collaborators) are 100% satisfied, would you merge it back into the main branch.<sup>1</sup>
...
- Very large individual files (>100 MB) exceed GitHub's maximum allowable size and should be ignored regardless. See <a href="https://help.github.com/articles/working-with-large-files/" target="_blank">here</a>.
]
...
- If you spot any problems with these lecture notes, feel free to file an issue [here](https://github.com/intro-to-data-science-24/lectures/issues)!
...
Now that you've learned the necessary basics, Assignment 1 is up on GitHub. Reminder: Also check out Assignment 0 to practice how to work on and submit assignments!
