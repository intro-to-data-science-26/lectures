...
subtitle: "Web scraping and APIs"
...
library(ipapi)
ip_df <- geolocate(c("", "10.0.1.1", "www.spiegel.de"), .progress=TRUE)
ip_df
```
...
There are many resources that give an overview of existing public APIs, including this [List of public APIs on GitHub](https://github.com/public-apis/public-apis). Another useful resource is [APIs for social scientists - a collaborative review](https://bookdown.org/paul/apis_for_social_scientists/).
...
Assignment 2 is about to go online. Check it out and start scraping the web (politely).
