...
<br>
<div align="center">
<img src="pics/arnie-this-is-not-a-database.gif" height=350 loop=infinite>
</div>
]
...
`Credit` [Posit.co](https://solutions.posit.co/connections/db/)
]
...
A comprehensive overview of database interaction using R is available at [posit.co](https://solutions.posit.co/connections/db/). It also features a set of best practices that go beyond what we covered today.
...
Let's finally do something useful with data!
