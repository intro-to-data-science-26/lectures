...
subtitle: "Web data and technologies"
...
<img src="pics/reputation-formation.png" height=440>
</div>
...
- (Used to be a) [W3C](https://en.wikipedia.org/wiki/World_Wide_Web_Consortium) standard for the construction of websites.
- The fundamentals of HTML haven't changed much recently. The latest W3C version is HTML5, which was released in 2014. The current specification, the [HTML Living Standard](https://en.wikipedia.org/wiki/HTML5#W3C_and_WHATWG_conflict), is maintained by the [WHATWG](https://whatwg.org/).
...
<div align="center">
<img src="pics/htmltree.png" width=450>
</div>
]
...
- The undoubtedly best way to learn it is [Xpath Diner](https://topswagcode.com/xpath/), inspired by [CSS Diner](https://flukeout.github.io/).
...
- Check out the [CSS diner tutorial](https://flukeout.github.io/). It's one of the best tutorials of anything out there.
...
No assignment due, but web technologies will be featured in the next assignment. There's a quiz though!
